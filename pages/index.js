  ...
  return (
    <div className="bg-gray-50 max-w-lg drop-shadow-2xl border-l-2 border-r-2 border-gray-500">
      ...
      <header className="justify-center items-center flex min-w-full p-1 h-60 text-center header">
        <div>
          <h1 className="text-9xl text-center font-extrabold text-yellow-400 text-opacity-90 ">
            Lari
          </h1>
      ...
      <main className="flex flex-col items-center">
        <div className="min-w-full">
          <div className="h-full flex justify-center pb-8 w-full px-8">
            <img
              src="/img/lari-perfil.jpg"
              alt="perfil lari"
              className="w-3/4 fade-in drop-shadow-2xl shadow-2xl rounded-full mt-14 border-2 border-yellow-400 border-opacity-40 border-dotted"
            />
          </div>
        ...
        <div className="min-w-full">
          <h2 className="text-5xl font-bold text-purple-700 m-8 text-center">
            Serviços
          </h2>
        ...
        <div className="bg-purple-700 justify-center">
          <h2 className="text-5xl font-bold m-8 p-3 text-center text-white pb-10">
        ...
        <div className="min-w-full text-center">
          <h2 className="text-5xl font-bold text-purple-700 m-8">
      ...
      <footer className="bg-pink-500 min-w-full text-lg flex flex-col items-start px-4">
